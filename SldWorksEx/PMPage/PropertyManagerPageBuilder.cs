...
using VPages.Core;
using VPages.Base;
using VPages.Binders;
using VPages.PageElements;
using System.Linq;
...
namespace CodeStack.SwEx.PMPage
{
        ...
        where THandler : PropertyManagerPageHandlerEx, new()
    {
        ...
        private class PmpAttributeSet : IAttributeSet
        {
            ...
            public void Add<TAtt>(TAtt att) where TAtt : VPages.Base.IAttribute
            {
                m_BaseAttSet.Add<TAtt>(att);
            }

            public TAtt Get<TAtt>() where TAtt : VPages.Base.IAttribute
            {
                return m_BaseAttSet.Get<TAtt>();
            }

            public IEnumerable<TAtt> GetAll<TAtt>() where TAtt : VPages.Base.IAttribute
            {
                return m_BaseAttSet.GetAll<TAtt>();
            }

            public bool Has<TAtt>() where TAtt : VPages.Base.IAttribute
            {
