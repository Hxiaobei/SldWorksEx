...
{
    /// <summary>
    /// State of macro feature parameters returned from <see cref="MacroFeatureEx{TParams}.SetParameters(IModelDoc2, IFeature, IMacroFeatureData, TParams, out OutdateState_e)"/>
    /// or <see cref="MacroFeatureEx{TParams}.SetParameters(IModelDoc2, IFeature, IMacroFeatureData, TParams, out OutdateState_e)"/> in cases
