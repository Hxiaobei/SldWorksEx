...
namespace SolidWorks.Interop.sldworks {
    ...
    public static class FeatureManagerEx {
        ...
        public static IFeature ReplaceComFeature<TMacroFeature>(this IFeatureManager featMgr, IFeature feat)
            ...
            var featData = (IMacroFeatureData)feat.GetDefinition()
        ...
        private static IFeature ReplaceComFeatureBase<TMacroFeature>(this IFeatureManager featMgr, IFeature feat, object parameters)
            ...
            if(featMgr.EditRollback((int)swMoveRollbackBarTo_e.swMoveRollbackBarToAfterFeature, feat.Name)) {
                ...
                IFeature newFeat = parameters != null
                ? InsertComFeatureWithParameters(featMgr, typeof(TMacroFeature), parameters)
                : InsertComFeature<TMacroFeature>(featMgr);
        ...
        private static IFeature InsertComFeatureWithParameters(IFeatureManager featMgr, Type macroFeatType, object parameters) {

            m_ParamsParser.Parse(parameters,
                out var paramNames, out var paramTypes, out var paramValues, out var selection,
                out var dimTypes, out var dimValues, out var editBodies);
        ...
        private static IFeature InsertComFeatureBase(IFeatureManager featMgr, Type macroFeatType,
            ...
            int[] dimTypes, double[] dimValues, object[] selection, IBody2[] editBodies) {
            ...
            var options = macroFeatType.TryGetAttribute<OptionsAttribute>()?.Flags
